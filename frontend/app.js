    ...
    return {
      ...
      translations: {
        'zh-CN': {
          ...
          adminPanel: {
            title: '网站总管理面板',
            sub: '这里集中查看站点服务健康状态，并进入学习、空间与消息工作区。',
            accessTitle: '管理员权限',
        ...
        'en-US': {
          ...
          adminPanel: {
            ...
            learningSub: 'Lesson browsing, series management, and content publishing.',
    ...
    installBuiltinLocales() {
      ...
      if (!this.translations['zh-TW']) {
        this.translations['zh-TW'] = this.deepMerge(
          ...
          adminPanel: {
            title: '網站總管理面板',
            sub: '這裡集中查看站點服務健康狀態，並進入學習、空間與訊息工作區。',
            accessTitle: '管理員權限',
